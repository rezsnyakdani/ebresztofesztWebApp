...
namespace Backend
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "�breszt� Fesztiv�l API", Version = "v1" });

                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    Description = "�rd be a 'Bearer' sz�t, egy sz�k�zt, majd a kapott tokent!\r\n\r\nP�lda: 'Bearer 12345abcdef'",
                    Name = "Authorization",
